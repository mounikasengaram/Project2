...
public class mouse2 {
	...
	a.moveToElement(d.findElement(By.xpath("//div[@id='smoothmenu1']/ul[2]/li/a"))).perform();
	List<WebElement>f=d.findElements(By.xpath("//div[@id='smoothmenu1']/ul[2]/li/ul/li/a"));
	System.out.println("no of elements:"+f.size());
